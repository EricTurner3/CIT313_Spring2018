...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" href="<?php echo BASE_URL?>">The Blog</a>
                    ...
                    echo ' <a class="dropdown-toggle" data-toggle="dropdown" href="#">' . $this->userObject->getUserName();
                                   ...
                                   echo ' <span class="caret"></span></a>
                                        <ul class="dropdown-menu">';
                                            echo '<li><a href="'.BASE_URL.'members/profile/'.$_SESSION["uID"].'">My Profile</a></li>';
                                            echo '<li><a href="'.BASE_URL.'profile/edit/'.$_SESSION["uID"].'">Edit My Profile</a></li>';
                                        if($this->userObject->isAdmin()){
                                            echo '<li><a href="'.BASE_URL.'manageposts">Post Manager</a></li>';
                                            echo '<li><a href="'.BASE_URL.'managecats">Category Manager</a></li>';
                                            echo '<li><a href="'.BASE_URL.'manageusers">User Manager</a></li>';
                                        }
